...
namespace RequisicionesAlmacen.Areas.Almacenes.Almacenes.Controllers
{
    ...
    {
        private string API_FICHA = "/almacenes/almacenes/cortesia/";
        ...
        public override ActionResult Nuevo()
        {
            ...
            {
                viewModel.Cortesia.Fecha = viewModel.FechaOperacion.GetValueOrDefault();
            }
        ...
        public ActionResult Ver(int id)
        {
            ...
            {
                //Asignamos la fecha
                modelo.FechaCortesia = new SistemaService().GetFechaConFormato(modelo.Fecha);
