ALTER TABLE ARtblInventarioMovimientoAgrupador ADD NumeroOficio VARCHAR(25)
GO
ALTER TABLE ARtblInventarioMovimientoAgrupador ADD Observaciones VARCHAR(2000)
GO
