...
CREATE OR ALTER VIEW [dbo].[MIvwListadoMatrizPresupuestoVigente]
AS
-- ===========================================
-- Author: Alonso Soto
-- Create date: 10/03/2020
-- Modified date: 
-- Description:	View para obtener el Listado de Matriz Presupuesto Vigente
-- ===========================================
SELECT 
	mir.MIRId, 
	mir.Codigo, 
...
FROM MItblMatrizIndicadorResultado mir
	...
	LEFT JOIN MItblMatrizConfiguracionPresupuestal mcp ON mcp.MIRId = mir.MIRId AND mcp.EstatusId = 1 AND mcp.ClasificadorId = 56
