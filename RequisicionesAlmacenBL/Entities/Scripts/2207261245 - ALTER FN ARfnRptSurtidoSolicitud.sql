...
(
	...
	FROM ARtblRequisicionMaterial AS requisicion
		 ...
		 LEFT JOIN tblPolizaRef AS pr ON agrupador.InventarioMovtoAgrupadorId = pr.Referencia AND pr.Tipo = 'A' AND pr.TipoMovimientoId = 75 -- Surtimiento de Requisición
